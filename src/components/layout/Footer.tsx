      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-6">
            <h2 className="text-xl font-bold tracking-tight">NIKE</h2>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="#" className="text-gray-400 hover:text-white transition-colors">Shoes</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white transition-colors">Clothing</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="#" className="text-gray-400 hover:text-white transition-colors">Running</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white transition-colors">Basketball</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white transition-colors">Soccer</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white transition-colors">Training</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white transition-colors">Tennis</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to="#" className="text-gray-400 hover:text-white transition-colors">Help</Link></li>
              ...
              <li><Link to="#" className="text-gray-400 hover:text-white transition-colors">Size Charts</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 sm:mt-0">
            <Link to="#" className="text-gray-400 text-sm hover:text-white transition-colors">Terms of Sale</Link>
            <Link to="#" className="text-gray-400 text-sm hover:text-white transition-colors">Terms of Use</Link>
